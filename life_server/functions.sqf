...
private[""_msg"",""_to""];
	...
	[] call life_fnc_cellphone;
	hint format[""You have sent a message to all Army Units."",_to,_msg];
	ctrlShow[3023,true];
";
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 6: {
			private[""_message""];
			_message = format[""!!!ARMY REQUEST: %1"",_msg];
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Army Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>You<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""TextMessage"",[format[""Army Request from %1"",_from]]] call bis_fnc_showNotification;
		};
	};
";
