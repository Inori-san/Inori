...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			case "charbonore": {"life_inv_charbonore"}; // Modif':05/08/2015
			case "carbonebrute": {"life_inv_carbonebrute"}; // Modif':05/08/2015
			case "fontebrute": {"life_inv_fontebrute"}; // Modif':05/08/2015
	...
	case 1:
	{
		switch (_var) do
		{
			case "life_inv_fontebrute": {"fontebrute"}; // Modif':05/08/2015
			case "life_inv_carbonebrute": {"carbonebrute"}; // Modif':05/08/2015
			case "life_inv_charbonore": {"charbonore"}; // Modif':05/08/2015
