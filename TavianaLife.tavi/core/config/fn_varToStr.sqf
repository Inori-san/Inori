...
switch (_var) do
{
	...
	case "life_inv_charbonore": {"Charbon Brute"}; // Modif':05/08/2015
	case "life_inv_carbonebrute": {"Carbone Brute"}; // Modif':05/08/2015
	case "life_inv_fontebrute": {"Fonte"}; // Modif':05/08/2015
	...
	//License Block
	case "license_civ_fonte": {"License de fonte"}; // Modif':05/08/2015
	case "license_civ_carbone": {"License de Carbone"}; // Modif':05/08/2015
