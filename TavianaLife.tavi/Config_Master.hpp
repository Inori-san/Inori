...
class Licenses {
	...
	LICENSEMACRO(packbase,"Pack standard","packbase",100000,false,"adac")
	LICENSEMACRO(packos,"Pack Old School","packos",100000,false,"adac")
	LICENSEMACRO(packsout,"Pack Soutien","packsout",100000,false,"adac")
	LICENSEMACRO(packsnip,"Pack Précision","packsnip",100000,false,"adac")
	LICENSEMACRO(packclq,"Pack Close Quarter","packclq",100000,false,"adac")
	LICENSEMACRO(packrpg,"Pack Lanceurs","packrpg",100000,false,"adac")
	LICENSEMACRO(packelite,"Pack Forces Spéciales","packelite",100000,false,"adac")
	LICENSEMACRO(packexplo,"Pack Démolisseur","packexplo",100000,false,"adac")
	LICENSEMACRO(packmun,"Pack de Munitions","packmun",100000,false,"adac")
	LICENSEMACRO(packacces,"Pack d'accessoires","packacces",100000,false,"adac")
};
