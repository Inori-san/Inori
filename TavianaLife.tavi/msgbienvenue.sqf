...
_welcomeMessage = format["Bienvenue sur TavianaLife %1",format["%1", name player]];
_camDistance = 40;
...
["Bienvenue sur TavianaLife","CENTER_UP",2] call arjay_dynamicText;
...
_role1 = "Bienvenue sur TavianaLife";
_role1names = ["Server only FR"];
_role2 = "Site/Forum";
_role2names = ["www.tavianalife.fr"];
_role3 = "TeamSpeak3";
_role3names = ["tavianalife.fr"];
_role4 = "Attention";
_role4names = ["Serveur Role Play - Only French "];
