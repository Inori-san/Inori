...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='\tavianalifefr_data\data\icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='\tavianalifefr_data\data\icons\money.paa'/> <t size='0.8'>$%2</t>",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
